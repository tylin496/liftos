...
export const COUNT_UP_MS = 600; // mirrors --dur-countup (tokens.css §Motion). Quad ease needs a touch longer to read as "counting"; the number settles just after the 500ms entrance (lands last)
